    ...
    def parse_ohlcv(self, ohlcv, market=None, timeframe='1m', since=None, limit=None):
        ...
        if isinstance(ohlcv, list):
            ...
            if 'd' in timeframe.lower():
                period_start_dt = datetime.datetime.utcfromtimestamp(timestamp / 1000)
                period_start_dt = period_start_dt.replace(hour=0, minute=0, second=0, microsecond=0,
                                                          tzinfo=datetime.timezone.utc)
                timestamp = int(period_start_dt.timestamp() * 1000)
            else:
                timestamp = timestamp
